 ...
 * Example 1:
 * 
 * Input: [[1, 2], [2, 3], [6, 1]] Output: [2, 5, 5] Explanation: After the
 * first drop of positions[0] = [1, 2]: _aa _aa ------- The maximum height of
 * any square is 2.
 * 
 ...
 * Example 2:
 * 
 * Input: [[100, 100], [200, 100]] Output: [100, 100] Explanation: Adjacent
 * squares don't get stuck prematurely - only their bottom edge can stick to
 * surfaces.
 * 
 * @author I339640
 *
...
public class FallingSquares {
	 ...
	 * that we have squares i intersect with us, which means my current square
	 * will go above to that square i. My target is to find the highest square
	 * and put square cur onto square i, and set the height of the square cur as
	 * 
	 * cur.height = cur.height + previousMaxHeight; Actually, you do not need to
	 * use the interval class to be faster, I just use it to make my code
	 * cleaner
	 */
