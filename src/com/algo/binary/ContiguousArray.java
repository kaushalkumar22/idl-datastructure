 ...
 * 
 * Input: [0,1] Output: 2 Explanation: [0,1] is the longest 
 * contiguous subarray with equal number of 0 and 1.
 * 
 * Input: [0,1,0] Output: 2 Explanation: [0, 1] (or [1, 0]) is a
...
public class ContiguousArray {
	...
	/*
	 * My idea is inspired by Best Time to Buy and Sell Stock.
	 * 
