...
public class LongestPalindromicSubstring {
	...
	public static String longestPalindrome(String s) {
		...
		for(int i=0;i<n;i++){
			expandAroundCenter(s,i,i);//assume odd length, extend around the center
			expandAroundCenter(s,i,i+1);//assume even length, extend around the center
		}
		return s.substring(stIndex,stIndex+maxLen);
	}
