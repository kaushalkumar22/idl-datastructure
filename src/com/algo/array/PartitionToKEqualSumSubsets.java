...
public class PartitionToKEqualSumSubsets {
	 ...
	 * number of elements in the current subset. Only if cur_sum = sum/k &&
	 * cur_num >0, we can start another look up process.
	 * 
	 * Some test cases may need to be added in: nums = {-1,1,0,0}, k = 4 nums =
	 * {-1,1}, k = 1 nums = {-1,1}, k = 2 nums = {-1,1,0}, k = 2 ...
	 */
