...
public class JumpGame {
	 ...
	 * curEnd(nums[i])] let nums[0]=2 means we can 2 cell so either at 3,4
	 * because range is [0,2] then we chose from 3,4 which can make max jump so
	 * its 4 so my next range is [curBegin(2), curEnd(nums[6])]
	 */
