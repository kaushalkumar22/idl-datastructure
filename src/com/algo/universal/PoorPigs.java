...
public class PoorPigs {
	 ...
	 * 21 22 23 24 25 
	 * 
	 * Now use one pig to find the row (make it drink from buckets 1, 2, 3, 4, 5, wait
	 * 15 minutes, make it drink from buckets 6, 7, 8, 9, 10, wait 15 minutes,
	...
	//	Or with logarithm like I've seen other people do it. That's also where I got the idea from 
	//(I didn't really try solving this problem on my own because the judge's solution originally was 
	//wrong and I was more interested in possibly helping to make it right quickly).
}
