 ...
 * on day i. Selling price needs to be larger than buying, Note that you cannot
...
public class BestTimeToBuyAndSellStock {
	 ...
	 * 3 (price = 5), profit = 5-1 = 4. Then buy on day 4 (price = 3) and sell on
	 ...
	 * transactions. Note: You may not engage in multiple transactions at the same
	 ...
	 * day 6 (price = 3), profit = 3-0 = 3. Then buy on day 7 (price = 1) and sell
	 ...
	 * transactions. You may not engage in multiple transactions at the same time
	 ...
	 * representing a transaction fee. You may complete as many transactions as you
	 * like, but you need to pay the transaction fee for each transaction. You may
	 * not buy more than 1 share of a stock at a time (ie. you must sell the stock
	 * share before you buy again.)
	 * 
	 * Return the maximum profit you can make. Input: prices = [1, 3, 2, 8, 4, 9],
	 * fee = 2 Output: 8 Explanation: The maximum profit can be achieved by: Buying
	 * at prices[0] = 1 Selling at prices[3] = 8 Buying at prices[4] = 4 Selling at
