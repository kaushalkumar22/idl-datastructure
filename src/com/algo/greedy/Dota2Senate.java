 ...
 * exercise one of the two rights: Ban one senator's right: A senator can make
 * another senator lose all his rights in this and all the following rounds.
 ...
 * there are n senators, the size of the given string will be n. The round-based
 * procedure starts from the first senator to the last senator in the given
 * order. This procedure will last until the end of voting. All the senators who
 * have lost their rights will be skipped during the procedure. Suppose every
 * senator is smart enough and will play the best strategy for his own party,
 * you need to predict which party will finally announce the victory and make
 * the change in the Dota2 game. The output should be Radiant or Dire. 
 
 * Example1: Input: "RD" Output: "Radiant" 
 * Explanation: The first senator comes from
 * Radiant and he can just ban the next senator's right in the round 1. And the
 * second senator can't exercise any rights any more since his right has been
 * banned. And in the round 2, the first senator can just announce the victory
 * since he is the only guy in the senate who can vote.
 * 
 * Example 2: Input: "RDD" Output: "Dire" 
 * Explanation: The first senator comes
 * from Radiant and he can just ban the next senator's right in the round 1. And
 * the second senator can't exercise any rights anymore since his right has been
 * banned. And the third senator comes from Dire and he can ban the first
 * senator's right in the round 1. And in the round 2, the third senator can
