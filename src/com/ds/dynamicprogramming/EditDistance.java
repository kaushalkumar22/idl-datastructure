 ...
 *in word 'w' which results in a word 'w1' which is also present in the given dictionary. For example, 
 *for dictionary {"BCCI","AICC","ICC","CCI","MCC","MCA", "ACC"}, minimum number of trials to reach from 
 *word "AICC" to "ICC" is 1. Only 1 opeartion of deleting character 'A' is required to reach from word "AICC" to word "ICC".
 * Minimum number of trials to reach from "AICC" to "MCC" is 2(AICC->ICC->MCC) and minimum number of trials to 
 * reach from "AICC" to "MCA" is 3(AICC->ICC->MCC->MCA).
...
public class EditDistance {
	...
	public static void main(String args[]){
		...
		System.out.print("Minimum Edit Distance: "+result);
	}
