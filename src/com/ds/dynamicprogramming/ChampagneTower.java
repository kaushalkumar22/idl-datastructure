 ...
 * right of those glasses, and so on. (A glass at the bottom row has it's excess
 * champagne fall on the floor.) For example, after one cup of champagne is
 * poured, the top most glass is full. After two cups of champagne are poured,
 * the two glasses on the second row are half full. After three cups of
 * champagne are poured, those two cups become full - there are 3 full glasses
 * total now. After four cups of champagne are poured, the third row has the
 * middle glass half full, and the two outside glasses are a quarter full, as
 * pictured below.
 * 
...
public class ChampagneTower {
	...
	public static void main(String[] args) {
		...
		System.out.println(champagneTower1(2,1,1));
	}
	...
	static double champagneTower1(int poured, int query_row, int query_glass) {
