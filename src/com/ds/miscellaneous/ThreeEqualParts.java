 ...
 * return any [i, j] with i+1 < j, such that: A[0], A[1], ..., A[i] is the first
 * part; A[i+1], A[i+2], ..., A[j-1] is the second part, and A[j], A[j+1], ...,
 * A[A.length - 1] is the third part. All three parts have equal binary value.
